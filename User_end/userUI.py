...
class RetrieveApp:
    def __init__(self, root):
        ...
        self.background_image = PhotoImage(file="./User_end/library2.png")
        ...
        clear_button["bg"] = "#8ca3ed"
        clear_button["justify"] = "center"
        clear_button["text"] = "Clear"
        clear_button.place(x=500,y=390,width=70,height=25)
